3:00 to 4:15 ---> OOPS-Inheritance
4:15 to 4:40 --->  Breakout+Break
4:40 to 5:15 ---> Polymorphism
5:15 to 5:35 ---> Breakout+Break
5:35 to 5:50 ---> Javawait,WebDrivermethod
5:50 to 6:00 ---> Recap
...
**Examples:**
  ...
  Java Wait:
   ---->it is applicable for each and every line and it will wait for the entire time we are specifying.
